...
define(function(){
    ...
    function Performance() {
      this.performance = {};
      this.isapp = Orange.isHybrid ? "1" : "0";
      this.defaults = {
        "Domready":       {
          "name": "JS.Orange.Domready",
          "tags": {}
        },
        "Onload":         {
          "name": "JS.Orange.Onload",
          "tags": {}
        },
        "AjaxReady":      {
          "name": "JS.Orange.AjaxReady",
          "tags": {
            "url": ""
          }
        },
        ...
        /* 记录 AJAX 响应的消息体长度信息 */
        "AjaxMessageSize":     {
          "name": "JS.Orange.AjaxMessageSize",
          "tags": {
            "url": ""
        ...
        "TemplateRender": {
          "name": "JS.Orange.TemplateRender",
          "tags": {
            "url":""
          }
        },
        "GeoRequest": {
          "name": "JS.Orange.GeoRequest",
          "tags": {
            "url":"",
    ...
    Performance.prototype = {
      ...
      send:     function (name, tag, value, ts) {
        ...
        if (name == 'JS.Orange.GeoRequest' && (typeof tag.url != 'string' || !tag.url.match(/^(Native|Web) function (number|detail|error)$/))) { return; }
      ...
      initOptions: function(opt) {
        ...
        opt.version = Orange.version; /*Orange版本号*/
        opt.isapp =  this.isapp;  /*web/hybrid*/
        opt.network   = Orange.networkType || 'unknown';  /*网络状况2g/3g/wifi*/
      },
      ...
      group:    function (id, opt) {
        ...
        opt.startTime = this.getTime();
        //-1…2014-08-19
        // opt.network = Orange.networkType || 'unknown';
