...
define(['cGuiderService', 'cMessageCenter','cLocalStorage'], function (Guider, MessageCenter,cStorage) {
  ...
  return function () {
    ...
    Orange.saveAppUrl = function (inView) {
    ...
    var _sendKenshoo = function () {
      var orderID = Orange.P("orderID"), // || Orange.P("oId") ; 此处暂不写oid的统计，没有明确文档说明oid需要统计
      type = Orange.P("type") || Orange.P("busType") || '',
      val = Orange.P("val") || Orange.P("price") || '';
      if (orderID) {
    ...
    var _sendMarin = function () {
      var orderID = Orange.P("orderID"), // || Orange.P("oId") ;
      type = Orange.P("type") || Orange.P("busType") || '',
      val = Orange.P("val") || Orange.P("price") || '';
      if (orderID) {
