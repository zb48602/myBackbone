 ...
 * @deprecated since Orange 2.1 / APP 6.0
 * @see cHybridShell
 */
define(['cHybridShell', 'cCommonStore'], function(cHybridShell, CommonStore) {
	...
	var exports = {
		...
		init: function() {
			...
			// 主动获取网络状态，并保持监听。
			callback = function(params) { Orange.networkType = params.networkType; };
			cHybridShell
		 ...
		 * @param  {string}   options.tagname       方法标签名（Orange）
		 ...
		 * @param  {string}   varname               方法标签名（Orange）
