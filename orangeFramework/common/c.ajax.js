...
define(['libs', 'cUtilPerformance'], function (libs, cperformance) {
  //为兼容Orange2.0, json去掉charset=utf-8 
  var contentTypeMap = {
  ...
  var ajax = (function ($) {
    ...
    function _sendReq(opt) {
      ...
      var obj = {
        ...
        timeout: Orange.timeout || opt.timeout || 50000,
  ...
  /**
  *@method promise
  *@description 执行完第一个才能执行第二个
  */
  function promise(function1,function2,callback){
    when( function(){   
    return $.Deferred(function1( defer ) {          
    }).promise();
    }, function(){  
    return $.Deferred(function2( defer ) {          
    }).promise();
    }).then(function(){  
